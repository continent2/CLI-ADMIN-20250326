...
import {RoleFilter} from "../member/RoleFilter.jsx";
...
export function Toolbar({table}) {
    ...
    return (
        <div className="table-toolbar">
            <div
                className={clsx(
                    "transition-content flex items-center justify-between items-center space-x-4 rtl:space-x-reverse",
