...
export const columns = [
    {
        ...
        cell: (info) => {
            ...
            const formattedTimestamp = timestamp
                ? `${dayjs(timestamp).locale(locale).format("YYYY-MM-DD")} | ${dayjs(timestamp).locale(locale).format("HH:mm:ss")}`
                : "N/A";
    ...
    },
    {
        ...
        cell: ({row}) => {
            ...
            const transferAmount = row.original["transfer.convamount"]; // Get transfer amount
            const transferCurrency = row.original["transfer.convcurrency"]; // Get transfer amount
            return (
                <div>
                    <p>
                    ...
                    <div style={{margin: "8px 0", borderBottom: "2px solid #ddd"}}/>
                    <p>{formatNumberWithCommas(transferAmount) || "N/A"} {transferCurrency || "N/A"}</p>
                </div>
            );
        },
    },
