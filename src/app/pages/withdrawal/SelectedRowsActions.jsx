            ...
            <div className="flex space-x-1.5 rtl:space-x-reverse">
              ...
              <Menu as="div" className="relative inline-block text-left">
                ...
                <Transition
                  ...
                  className="absolute z-[100] w-[10rem] rounded-lg border border-gray-300 bg-white py-1 text-xs+ text-gray-600 shadow-soft outline-none focus-visible:outline-none dark:border-dark-500 dark:bg-dark-750 dark:text-dark-200 dark:shadow-none"
