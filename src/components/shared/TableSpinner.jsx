...
const TableSpinner = forwardRef((props, ref) => {
  const {
    className,
    animate = true,
    isElastic,
  ...
  if (variant === "default" || variant === "soft") {
    return (
      <div className="flex h-[34rem] w-full items-center justify-center">
        <div
          ref={ref}
          className={clsx(
              ...
              variant === "default"
                ? [
                    color === "neutral"
                      ...
                      : [
                          setThisClass(color),
                          "border-this dark:border-this-light",
                        ],
...
TableSpinner.displayName = "Spinner";
